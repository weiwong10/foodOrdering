...
if (isset($_POST['submit'])) {
  ...
  $customer_query = mysqli_query($conn, "UPDATE customer SET name = '" . $_POST['customerName'] . "', email = '" . $_POST['email'] . "', contactNo = '" . $_POST['telephone'] . "', address = '" . $_POST['address'] . "', password = '" . md5($_POST['password']) . "' WHERE customerID ='$id' ");
      ...
      <div class="right">
        <div class="form">
          <form action="" method="post">
            <label>Name</label>
            <input type="text" style="font-size: 16px" placeholder="Name" name="customerName" value="<?php echo $row['name'] ?>">

            <label>Email</label>
            <input type="text" style="font-size: 16px" placeholder="Email" name="email" value="<?php echo $row['email'] ?>">

            <label>Telephone</label>
            <input type="text" style="font-size: 16px" placeholder="Telephone" name="telephone" value="<?php echo $row['contactNo'] ?>">
